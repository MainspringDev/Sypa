...
$builder->addDefinitions(__DIR__ . '/../parameters.php');
$builder->addDefinitions(__DIR__ . '/../services.php');
$builder->addDefinitions(__DIR__ . '/../listeners.php');
$builder->addDefinitions(__DIR__ . '/../decorators.php');
...
set_exception_handler(function (\Exception $e) use ($log, $config) {
    if ($config->get('error_display')) {
